...
(function (global, factory) {
  ...
  var jexcel = function (el, options) {
     ...
     * @return null
     */
    obj.getBlob = function (includeHeaders, mimeType) {
      if (obj.options.allowExport == false) {
        console.error("Export not allowed");
      } else {
        // Data
  ...
  jexcel.fromBase64Blob = function (base64Blob, __callback) {
    const convert = function (workbook) {
      var spreadsheets = [];
      workbook.SheetNames.forEach(function (sheetName) {
        var spreadsheet = {};
        spreadsheet.rows = [];
    ...
    if (typeof Uint8Array !== "undefined") {
      ...
      var ff = convertResponseBodyToText(_base64ToArrayBuffer(base64Blob));
      var wb = XLSX.read(ff, {
        type: "binary",
        cellFormula: true,
        cellStyles: true,
